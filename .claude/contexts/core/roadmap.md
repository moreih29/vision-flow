...
**목표**: Subset 기반 데이터 큐레이션 + UI 고도화

### 완료 항목
- [x] Subset CRUD (Task Type 지정)
- [x] Subset ↔ Image 멤버십 관리
- [x] 라벨 클래스 CRUD
...
- Phase 3은 Phase 2의 Subset/클래스 관리에 의존
...
5. **대형 컴포넌트**: DataPoolTab(~800줄), FolderTreeView(~1000줄) 분할 필요.
